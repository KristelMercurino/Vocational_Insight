...
import { TextField, Button, Grid, Typography, InputAdornment, IconButton, LinearProgress } from '@mui/material';
...
const ResetPassword = () => {
    ...
    return (
        <Grid container style={{ minHeight: '100vh', backgroundColor: '#2c3e50ff', margin: 0, padding: 0 }}>
            ...
            <Grid item xs={12} sm={6} md={6} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#f4f4f4', padding: '2rem' }}>
                <Grid item xs={12} sm={10} md={8}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        {mensaje && <Typography variant="body2" color="primary" style={{ marginBottom: '1rem' }}>{mensaje}</Typography>}

                        <Button
                            variant="contained"
                            color="primary"
                            fullWidth
                            style={{ backgroundColor: '#A3D6C4', padding: '12px', fontWeight: 'bold', fontSize: '16px', borderRadius: '5px', transition: 'background-color 0.3s ease', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2)' }}
                            type="submit"
                        >
                            CAMBIAR CONTRASEÑA
                        </Button>
